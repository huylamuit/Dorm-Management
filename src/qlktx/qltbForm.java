 ...
 * @author ASUS
 */
public class qltbForm extends javax.swing.JPanel implements ActionListener  {
    ...
    public qltbForm(String truongtoa, String sinhvien) {
        initComponents();
        this.tacgia = truongtoa;
        loadData();
        System.out.println(this.tacgia);    
    ...
    public void loadData(){
        ...
        if(test.size() == 0){ 
            ...
            pnlThongBao.setPreferredSize(new Dimension(1340,150 * n + 200));
            for(int i = 0; i < n; i++){
               JButton temp = new JButton();
               temp.setBackground(new Color(230,230,230));
               temp.setPreferredSize(new Dimension(1220, 150));
    ...
    private void initComponents() {
        ...
        pnlThongBao.setPreferredSize(new java.awt.Dimension(1340, 1000000));
        pnlThongBao.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 50, 25));
        jScrollPane1.setViewportView(pnlThongBao);

        pnlContainer.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1340, 780));

        add(pnlContainer, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 100, 1340, 780));

        btnAdd.setBackground(new java.awt.Color(94, 119, 141));
        btnAdd.setActionCommand("btnBack");
        ...
        add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 30, 70, 70));
        ImageIcon avt = new ImageIcon("image/Add.png");
        ...
        add(btnRefresh, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 30, 70, 70));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        ThongBaoForm tb = new ThongBaoForm(tacgia);
        tb.setVisible(true);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        for(JButton x:btnChiTiet){
            if(e.getSource() == x){
                ...
                ThongBaoForm tb = new ThongBaoForm(tacgia, test.get(temp).getMaTB());
                tb.setVisible(true);
            }
        }
